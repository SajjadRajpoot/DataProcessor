        ...
        btnFetch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!userMsisdn.isEmpty()) {
                    ...
                    Toast.makeText(MainUserActivity.this, "Please enter User ID", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private class FetchDataTask extends AsyncTask<String, Void, List<User>> {
        ...
        protected void onPostExecute(List<User> users) {
            ...
            if (users != null && !users.isEmpty()) {
                ...
                Toast.makeText(MainUserActivity.this, "No data found or error occurred", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
